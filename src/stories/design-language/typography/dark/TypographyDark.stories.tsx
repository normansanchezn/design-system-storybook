...
const TypographyDarkView = () => (
  <div className="ds-typography-page" data-theme="dark">
...
const meta = {
  title: "Design Language/Typography/Dark",
  component: TypographyDarkView,
  parameters: {
    layout: "fullscreen",
  },
  tags: ["autodocs"],
} satisfies Meta<typeof TypographyDarkView>;

export default meta;
type Story = StoryObj<typeof meta>;

export const Tokens: Story = {
  render: () => <TypographyDarkView />,
};
